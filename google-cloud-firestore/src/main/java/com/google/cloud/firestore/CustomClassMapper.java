    ...
    public Map<String, Object> serialize(T object) {
      ...
      for (String property : properties.values()) {
        ...
        if (serverTimestamps.contains(property) && propertyValue == null) {
          ...
          serializedValue = CustomClassMapper.serialize(propertyValue);
        }
